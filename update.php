<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="update `student` set id=$id, username='$username', rollNumber='$rollNumber', gender='$gender' where id='$id'";
        ...
        <div class="inner-container">
            <form method="POST" onsubmit="return ValidateForm()">
                ...
                <div class="input-group">
                    ...
                    <input type="radio" name="gender" id="genid" value="male">
                    <label for="male">Female</label>
                    <input type="radio" name="gender" id="genid" value="female">
